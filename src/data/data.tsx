...
const data = [
    {title: "Fruitinator", image: frutinator, link: "https://www.fruitinator.org", tags: ["React.js","Javascript", "MobX", "SASS"], text: "An e-commerce frontend to shop for exotic fruits on desktop and mobile devices"},
    {title: "Portfolio Website", image: portfolio, link: "https://www.pygineer.info", tags: ["Next.js","Typescript","Tailwind CSS"], text: "Portfolio single page website with mobile first design philosophy hosted on Github Pages"},
    {title: "Monomind", image: jblaster, link: "https://www.monomind.info", tags: ["React.js","Typescript","Web Audio API", "CSS"], text: "Monophonic synthesizer to play and record synth bass lines from the 80s"},
